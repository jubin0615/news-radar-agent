...
export default function LoginPage() {
  return (
    <div
      className="login-page flex h-screen w-screen items-center justify-center overflow-hidden"
    ...
    >
      ...
      <div className="login-card relative z-10 flex w-full max-w-sm flex-col items-center gap-8 rounded-2xl p-8">
        {/* Logo */}
        <div className="flex flex-col items-center gap-4">
          <div className="login-logo-ring">
            <div className="login-logo-inner">
              <Radar size={32} style={{ color: "var(--neon-blue)" }} strokeWidth={1.8} />
            </div>
          </div>
        ...
        <div className="flex w-full flex-col gap-3">
          ...
          >
            <span className="login-btn-glow login-btn-glow-blue" />
          ...
          <button
            ...
            className="login-btn group"
          >
            <span className="login-btn-glow login-btn-glow-purple" />
            ...
            <span className="relative z-10">GitHub로 계속하기</span>
          </button>
        </div>
      </div>
    </div>
